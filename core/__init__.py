...
def setup_routers() -> Router:
    from . import chat_dialogue, demo_catcher, email_catcher, demo_listener, forum_dialogue
    from core.helpers import forum_sender
    ...
    router.include_router(forum_sender.router)
