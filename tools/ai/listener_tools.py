...
class OpenAIListener:
    ...
    def __init__(self):
        ...
        self.listen_content = """Ты Кибер Папер, цифровая копия Павла Paperclip - drumandbass продюсера из Санкт-Петербурга.
