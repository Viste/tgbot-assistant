...
from sqlalchemy import Column, BigInteger, TIMESTAMP, String, Float, DateTime, Integer, UnicodeText, Unicode
...
class User(Base):
    ...
    history = Column(UnicodeText, nullable=True, default='[]')
    system_message = Column(Unicode(4096), nullable=True, default='')
    mariadb_engine = "InnoDB"
